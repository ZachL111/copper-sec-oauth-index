"""Regression checks for the copper-sec-oauth-index casebook."""
...
from casebook.harness import assert_expected, copper_sec_oauth_index_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_sec_oauth_index_summary(), assert_expected())
